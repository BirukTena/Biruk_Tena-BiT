    ...
    return (
        <div className="h-full md:h-screen splash-screen dark:splash-screen-dark transition duration-500">
            ...
            <div
                ...
                ref={el => titleText = el}>
                <p className="transition-all duration-500 text-black dark:text-yellow-500 text-7xl"><span className="transition-all duration-500 text-yellow-500 dark:text-white">Daily Sleep</span> Tracker</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 mt-14">
                ...
                <div
                    ...
                    <p className="text bg-gray-600 dark:bg-gray-500 text-yellow-500 dark:text-yellow-400 text-center p-10 lg:p-8 rounded-full my-10 ml-20">Once you have a few entries, <span className="text-white dark:text-white">Daily Sleep Tracker</span> can offer you some insights about your sleep health.</p>
